...
subjs, data = accumulate_data(
    'finetune_mlp_' + MLP_MODEL + '_[\'1\', \'2\', \'3\', \'4\'].pkl', subjs, data)
subjs, data = accumulate_data(
    'finetune_mlp_' + MLP_MODEL + '_[\'5\', \'6\', \'7\', \'8\'].pkl', subjs, data)
subjs, data = accumulate_data(
    'finetune_mlp_' + MLP_MODEL + '_[\'10\', \'11\', \'12\', \'13\'].pkl', subjs, data)
subjs, data = accumulate_data(
    'finetune_mlp_' + MLP_MODEL + '_[\'14\', \'15\', \'16\', \'17\'].pkl', subjs, data)
subjs, data = accumulate_data(
    'finetune_mlp_' + MLP_MODEL + '_[\'18\', \'19\', \'20\'].pkl', subjs, data)
subjs, data = accumulate_data(
    'finetune_mlp_' + MLP_MODEL + '_[\'21\', \'22\', \'23\'].pkl', subjs, data)
...
for i in range(1, ROWS*COLS + 1):
    fig['layout'].update(title='MLP: Dense(20)x6')
